...
class BuyerReceiveItemList extends React.Component {
	...
	itemCount() {
		if (this.props.purchaseHistory.total.to_recieve) {
			return this.props.purchaseHistory.total.to_recieve.items_count
		}
	}

	subTotalCount() {
		if (this.props.purchaseHistory.total.to_recieve) {
			return this.props.purchaseHistory.total.to_recieve.subtotal_count
		}
	}
		...
		return (
			<View style={styles.cardItem}>
				...
				<View style={styles.footer}>
					<Text style={styles.label}>{'Thank you for order. Order is processing.'}</Text>
		...
		return (
			<KeyboardAvoidingView style={styles.container}>
				<FlatList
					...
					data={purchaseHistory.to_recieve}
				...
				/>
				{purchaseHistory.total?.to_recieve && <View style={styles.button} onPress={this.onclickContinue}>
