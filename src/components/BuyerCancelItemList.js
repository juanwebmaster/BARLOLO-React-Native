...
class BuyerCancelItemList extends React.Component {
	...
	itemCount() {
		if (this.props.purchaseHistory.total.return_refund) {
			return this.props.purchaseHistory.total.return_refund.items_count
		}
	}

	subTotalCount() {
		if (this.props.purchaseHistory.total.return_refund) {
			return this.props.purchaseHistory.total.return_refund.subtotal_count
		}
	}
		...
		return (
			<KeyboardAvoidingView style={styles.container}>
				<FlatList
					...
					data={purchaseHistory.return_refund}
				...
				/>
				{purchaseHistory.total?.return_refund && <View style={styles.button} onPress={this.onclickContinue}>
