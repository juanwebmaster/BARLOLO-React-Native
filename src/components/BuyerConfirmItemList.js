...
class BuyerConfirmItemList extends React.Component {
	...
	itemCount() {
		if (this.props.purchaseHistory.total.seller_to_confirm) {
			return this.props.purchaseHistory.total.seller_to_confirm.items_count
		}
	}

	subTotalCount() {
		if (this.props.purchaseHistory.total.seller_to_confirm) {
			return this.props.purchaseHistory.total.seller_to_confirm.subtotal_count
		}
	}
		...
		return (
			<View style={styles.cardItem}>
				...
				<View style={styles.footer}>
					<Text style={styles.label}>{'Waiting seller to confirm stock and delivery fees pending.'}</Text>
					<TouchableOpacity style={styles.contactBtn} onPress={this.contactAdmin}>
						<Text style={styles.contactBtnLabel}>{i18n.t('Contact Admin')}</Text>
					</TouchableOpacity>
				</View>
			</View>
		);
		...
		return (
			<KeyboardAvoidingView style={styles.container}>
				<FlatList
					...
					data={purchaseHistory.seller_to_confirm}
				...
				/>
				{purchaseHistory.total?.seller_to_confirm && <View style={styles.button} onPress={this.onclickContinue}>
