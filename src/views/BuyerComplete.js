...
import BuyerCompleteItemList from '../components/BuyerCompleteItemList';
import LoadingComponent from '../components/LoadingComponent';
import PurchaseCarousel from '../components/PurchaseCarousel';

import i18n from "@app/locale/i18n";

class BuyerComplete extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.blurListener = navigation.addListener('didBlur', ({state, action}) => {
      if(this._carousel) this._carousel.snapToItem(3);
    });
  }
    ...
    return (
      <Fragment>
        ...
        <SafeAreaView style={styles.container}>
          ...
          <PurchaseCarousel childRef={(c) => { this._carousel = c; }} navigation={navigation} active={3} />
          <BuyerCompleteItemList navigation={navigation} />
