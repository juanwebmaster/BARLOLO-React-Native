...
class RecommendedStore extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Fragment>
        ...
        <SafeAreaView style={styles.container}>
          <NavHeader navigation={navigation} title={i18n.t('Recommended Store')} isCartBtn={true}/>
          <FlatList
            style={{flex: 1}}
...
const mapStateToProps = ({ auth, user, shop, home }) => ({
